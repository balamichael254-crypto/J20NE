(function () {
  ...
  const worlds = [
    ...
    world('Maldives, No Schedule', 'a room floating on water',
      ...
      ['Breakfast in the water', 'Someone floats a tray of breakfast to us. It is ridiculous. We eat all of it.', 1],
      ['The slow swim', 'Warm water, no current, nowhere to swim to. We float and argue gently about nothing.', 1],
      ['Fish that ignore us', 'Snorkels on. A whole city of fish below carrying on with its day, entirely unbothered by us.', 1],
      ['Dinner on the sand', 'A table set right on the beach, lanterns pushed into the sand, waves close enough to hear between sentences.', 1],
      ['Stars with no city', 'No streetlights for a hundred miles. The sky is absurd. You go quiet, which is how I know it got you too.', 1],
      ['Last swim before the flight', 'One more, quickly, still in yesterday\'s clothes. We are late because of it and neither of us minds.', 1],
    ]),
    world('Paris After Midnight', 'the city when it whispers',
      ...
      'paris', gallery('paris'), [
      ['The tiny cafe', 'You choose the prettier pastry. I claim I only want one bite and immediately become a liar.', 1],
      ['A bridge at midnight', 'We stop halfway across because you want to look at the water. The city keeps going without us.', 1],
      ['The tower sparkles', 'On the hour it does the thing. You have seen it a hundred times online and still gasp. I love that about you.', 1],
      ['The bookshop still open', 'A yellow window at one in the morning. We go in for two minutes and stay for forty.', 1],
      ['Streets after rain', 'Everything doubled in the wet stone. You walk slower here without noticing you are doing it.', 1],
      ['Walking home', 'No taxi. We choose the long way on purpose and neither of us says why.', 1],
      ['The last métro we miss', 'It goes without us while we are still deciding. Good. Now the night has to keep going.', 1],
    ]),
    world('Kyoto Blossom Rain', 'petals in your hair',
      ...
      'kyoto', gallery('kyoto'), [
      ['Temple morning', 'We arrive before the crowds. Bells sound somewhere beyond the trees and your hand finds mine inside my coat pocket.', 1],
      ['The red gates', 'A tunnel of them going up the hill, further than either of us expects. We climb further than we meant to.', 1],
      ['Tea for two', 'We sit by a paper window while steam curls between us. You taste mine. I knew you would.', 1],
      ['Petal weather', 'A gust fills the path with blossoms. I brush one from your hair and leave the prettiest one there.', 1],
      ['The bamboo hour', 'Green light, wind in the tops, the sound of a place breathing. We stop talking for a while.', 1],
      ['Lantern evening', 'The lanes glow gold after dark. We walk slowly because the night deserves our full attention.', 1],
      ['River, last light', 'We sit on the bank with cold drinks and watch the light leave the water.', 1],
    ]),
    world('Zanzibar Barefoot Morning', 'salt, spice, and sunlight',
      ...
      ['Sunrise feet', 'The tide is far out. We walk on wet sand for what feels like a mile and the sun comes up the whole way.', 1],
      ['Stone Town doors', 'Carved wooden doors on every corner, each one older than both of us. You photograph nearly all of them.', 1],
      ['Spice market', 'You hold cardamom to my nose and I pretend to be an expert. We buy far too much of everything.', 1],
      ['The blue hour swim', 'Bath-warm water and nobody else in it. We stay in until our fingers go strange.', 1],
      ['Dhow at dusk', 'A wooden sail against an orange sky. We sit at the front and let the boat do the talking.', 1],
      ['Rooftop dinner', 'Grilled fish, lime, and the call to prayer drifting over the roofs while we eat.', 1],
      ['Night on the sand', 'Warm dark, no wind, the water still going in and out. We stay far later than we planned.', 1],
    ]),
    world('The Swiss Window Seat', 'mountains passing like cinema',
      ...
      ['Window-seat treaty', 'We agree to swap every twenty minutes. Neither of us honours it. It works out anyway.', 1],
      ['The first tunnel', 'Dark, then suddenly an entire valley. You make the same small sound every time and I wait for it.', 1],
      ['A small mountain town', 'We get off somewhere unplanned because it looked pretty. It is. We eat there.', 1],
      ['Lunch with a view', 'Bread, cheese, something warm, and a mountain doing nothing dramatic outside the window.', 1],
      ['The quiet carriage', 'You fall asleep on my shoulder somewhere after the lake. I do not move for forty minutes.', 1],
      ['Lake evening', 'Still water, mountains upside down in it, cold air that makes standing close a practical decision.', 1],
      ['Late arrival', 'A small station, our breath visible, and nowhere to be until tomorrow.', 1],
    ]),
    world('Bali Hidden Garden', 'green doors and flower baths',
      ...
      'bali', gallery('bali'), [
      ['Breakfast among leaves', 'Fruit we cannot identify, coffee we can, and the jungle doing its enormous green thing on all sides.', 1],
      ['The flower bath', 'Petals across the whole surface. You are delighted. I take the photo you pretend not to want.', 1],
      ['The rice terraces', 'Steps of green going down a whole hillside. We walk them badly, in the wrong shoes, laughing.', 1],
      ['Scooter road', 'Your arms around me, palm shadows flicking past, both of us going far too slowly to be cool.', 1],
      ['The water temple', 'Cold spring water and something serious in the air. We stop being loud without discussing it.', 1],
      ['Rain on the roof', 'It arrives all at once, the way it does here. We stay put and let it be loud.', 1],
      ['Fireflies after dinner', 'The garden fills with small moving lights. You whisper for no reason. So do I.', 1],
    ]),
    world('Cappadocia Before Sunrise', 'balloons above the quiet',
      ...
      ['The 4:30 alarm', 'You threaten violence. You get up anyway. Ten minutes later you are the one hurrying me.', 1],
      ['The valley in the dark', 'Cold air, strange rock shapes, and the sky only just beginning to think about it.', 1],
      ['The sky fills', 'First one, then ten, then more than we can count. You hold my arm without looking away.', 1],
      ['Our own basket', 'Off the ground before we are ready. You go completely silent, which from you means everything.', 1],
      ['Breakfast after wonder', 'Eggs, olives, bread, and neither of us able to fully stop grinning about what we just saw.', 1],
      ['Cave-room nap', 'Thick stone walls, cool dark, the whole day still ahead. We sleep for two hours and regret nothing.', 1],
      ['Sunset on the rocks', 'Back out for the other end of the day, the whole valley going orange and pink.', 1],
    ]),
    world('Venice After Rain', 'reflections under every bridge',
      ...
      ['One shared umbrella', 'It is too small for two people. We use it anyway and both get half wet.', 1],
      ['Getting beautifully lost', 'The map gives up. We turn down whichever alley looks better and it always does.', 1],
      ['Coffee standing up', 'Like the locals, at a counter, quickly, for a fraction of the price. You approve of this system.', 1],
      ['A quiet gondola', 'Touristy and we do not care. Under a low bridge you go quiet and hold my hand tighter.', 1],
      ['The square at dusk', 'Pigeons, orchestras competing from opposite cafes, and the light going pink on the water.', 1],
      ['Tiramisu verdict', 'We try it in three places to be scientific. You have strong opinions. I write them down.', 1],
      ['Last vaporetto', 'The city sliding past on the water, cold air, your head on my shoulder.', 1],
    ]),
    world('Nairobi and Diani, Our Kenya Date', 'candlelight in Nairobi, bare feet in Diani',
      ...
      'kenya', gallery('kenya'), [
      ['Candlelit Nairobi', 'A table booked for a Tuesday for no reason. You in that dress, and me forgetting most of my sentences.', 1],
      ['The road to Diani', 'Windows down, playlist loud, the landscape changing from town to green to salt air.', 1],
      ['First sight of the water', 'That specific blue that does not photograph properly. You stop walking when you see it.', 1],
      ['Two loungers, one view', 'Books we do not read, drinks that sweat in the heat, hours that stop counting themselves.', 1],
      ['Fresh fish, no cutlery', 'Grilled that morning, eaten with our hands at a plastic table. Best meal of the trip and we both know it.', 1],
      ['Barefoot after sunset', 'Warm sand, cold water at the ankles, and the two of us walking much further than intended.', 1],
      ['Night drive back', 'Windows down again, quieter now, your hand on my knee and nobody saying much.', 1],
    ]),
    world('Seychelles Secret Cove', 'granite, lilies, clear water',
      ...
      ['The hidden path', 'A gap in the trees somebody told us about. Ten minutes of scrambling and then nobody else at all.', 1],
      ['The granite boulders', 'Huge, warm from the sun, shaped like something poured rather than placed.', 1],
      ['A private picnic', 'Bread, cheese, mangoes, and sand in absolutely everything by the end of it.', 1],
      ['Water like glass', 'You can count your toes in three feet of it. We stand around in the shallows for an hour.', 1],
      ['Reading beside you', 'Two books, no talking, your foot against mine. Somehow one of my favourite hours.', 1],
      ['Last swim', 'The light goes gold and we go back in for one more, because leaving felt premature.', 1],
      ['The walk back in the dark', 'Phone torch, warm air, your hand because the path is uneven and also because.', 1],
    ]),
    world('London Bookshop Rain', 'stories, tea, and your hand',
      ...
      ['The note in the book', 'I hide one for you on a shelf in the poetry section. You find it faster than I planned.', 1],
      ['Second-hand stacks', 'Towers of them, no discernible system, and the specific smell of old paper you like.', 1],
      ['Afternoon tea', 'Tiny sandwiches we make fun of and then finish entirely. You take the last scone. Fair enough.', 1],
      ['Museum wandering', 'Big quiet rooms, whispered opinions about paintings, and a bench we sit on for far too long.', 1],
      ['The rain gets serious', 'We give up on the plan and stand in a doorway watching it come down.', 1],
      ['A pub with a fire', 'Corner table, something warm, coats steaming gently. Nowhere better to be.', 1],
      ['Rainy bus window', 'Top deck, front seats, the whole city sliding past behind water on the glass.', 1],
    ]),
    world('Rome at Golden Hour', 'warm stone and slow evenings',
      ...
      'rome', gallery('rome'), [
      ['Morning espresso', 'Standing at the bar, one shot, thirty seconds, out again. You take to this immediately.', 1],
      ['A coin and a wish', 'Over the shoulder, eyes shut. You will not tell me what you wished for. I have theories.', 1],
      ['Ruins at noon', 'Two thousand years of stone and you asking better questions than the guide answers.', 1],
      ['Pasta lesson', 'Flour everywhere, dough behaving badly, and you laughing at my technique for a solid ten minutes.', 1],
      ['Gelato, second one', 'We said one. We are on our second. We will probably have a third.', 1],
      ['Steps after sunset', 'We sit on warm stone with everyone else and watch the sky do the pink thing over the roofs.', 1],
      ['The long way to dinner', 'Through three piazzas we did not need to cross, because you wanted to keep walking.', 1],
    ]),
    world('Northern Lights Cabin', 'the sky learning magic',
      ...
      ['Cabin afternoon', 'Firewood, thick socks, and the light already going at three in the afternoon.', 1],
      ['Snow walk', 'Blue light, absolute silence, and the crunch of two sets of boots.', 1],
      ['The waiting game', 'Hot drinks, one eye on the window, checking a forecast neither of us understands.', 1],
      ['The first green ribbon', 'You see it before me and grab my arm hard enough to hurt. Worth it.', 1],
      ['Under one blanket', 'Outside, freezing, refusing to go in while the sky is still doing that.', 1],
      ['Firelight after', 'Back inside, faces cold, hands wrapped around mugs, both slightly stunned.', 1],
      ['Morning, all white', 'Snow on everything, sun low and pink on it, and nowhere at all we need to be.', 1],
    ]),
    world('Marrakech Lantern Night', 'rose walls and amber light',
      ...
      ['Courtyard morning', 'Mint tea, tiled floor, a fountain going quietly, and the whole city locked outside the door.', 1],
      ['The souk', 'Narrow, crowded, gorgeous, overwhelming. You navigate it better than I do.', 1],
      ['Choosing a keepsake', 'One lamp, forty minutes of deliberation, and a negotiation you conduct with total confidence.', 1],
      ['The blue garden', 'Cool, green, unreasonably photogenic. We slow right down inside it.', 1],
      ['Rooftop sunset', 'The whole pink city going gold, swifts everywhere, and the call to prayer starting up across it.', 1],
      ['Lantern dinner', 'Amber light through cut metal, food that keeps arriving, and no interest in leaving.', 1],
      ['The square at night', 'Smoke, music, a hundred things happening at once. We hold hands so as not to lose each other.', 1],
    ]),
    world('Amalfi Lemon Afternoon', 'sunlight the color of joy',
      ...
      ['The coastal drive', 'Hairpins, sheer drops, and you leaning across me to see the water each time.', 1],
      ['The town from above', 'Stacked pastel houses going down to a small harbour. It looks invented.', 1],
      ['Lemon garden lunch', 'Pasta, lemonade, shade, and a long meal that resets a whole nervous system.', 1],
      ['The swimming stairs', 'Down a hundred steps to a tiny platform on the rocks. Cold, deep, perfect water.', 1],
      ['A boat for an hour', 'Out past the cliffs where the water goes properly dark blue, engine off, just floating.', 1],
      ['Balcony music', 'Someone practising somewhere below, badly, sweetly, while the light goes orange on the water.', 1],
      ['Limoncello, cold', 'Tiny glasses, far too sweet, and both of us pretending we are used to it.', 1],
    ]),
    world('Our Tiny Kitchen', 'the destination called ordinary',
      ...
      ['Sleepy coffee', 'You, half awake, holding the mug with both hands. I have wanted this exact scene for a long time.', 1],
      ['The grocery run', 'Arguing about which pasta shape while blocking an entire aisle. Domestic and perfect.', 1],
      ['Dinner experiment', 'We follow the recipe loosely and it goes fine. You taste-test everything. Quality control.', 1],
      ['Music between chores', 'Something on the speaker, you dancing badly at the sink, me pretending not to watch.', 1],
      ['Eating on the floor', 'The table is covered in something else. The floor works. It always does.', 1],
      ['The refrigerator evidence', 'Photos, a bad drawing, one note you left on a Tuesday that I never took down.'],
      ['Washing up, badly', 'You wash, I dry, one of us keeps flicking water. It takes twice as long as it should.', 1],
    ]),
    world('The Sunday Bedroom Fort', 'rain outside, us inside',
      ...
      ['Fort construction', 'Every blanket in the house is now structural. You are in charge. I am labour.', 1],
      ['Rain on the window', 'Grey light, water running down the glass, and absolutely nowhere to be.', 1],
      ['The snack delivery', 'Two trips because I am ambitious. Crumbs immediately become a permanent feature.', 1],
      ['A movie we barely watch', 'Twenty minutes in, we are talking over it. Neither of us knows how it ends.', 1],
      ['The nap that happens', 'Not planned. Grey light, warm blankets, both of us out for an hour and a half.', 1],
      ['Small talk, big topics', 'It starts about nothing and ends somewhere serious, the way it does when there is time.', 1],
      ['Falling asleep nearby', 'Lights off, rain still going, your breathing slowing down before mine does.', 1],
    ]),
    world('Twenty-Fifth of February', 'our date, made into a place',
      ...
      ['The anniversary garden', 'Everything planted on one date and still going. It gets bigger every year without asking us.', 1],
      ['Letters at noon', 'We read what we wrote a year ago. Some of it is embarrassing. All of it is true.', 1],
      ['The same song', 'The one from that week. It has not improved. It never had to.', 1],
      ['A cake, no occasion', 'Well, one occasion. Candles anyway, in the afternoon, for no good reason.', 1],
      ['The photo we retake', 'Same pose, different year, both of us slightly different. We keep every version.', 1],
      ['Counting out loud', 'Days, months, the number of times we nearly gave up and did not. The last number is zero.', 1],
      ['The next-year wish', 'One each, said out loud, written down, and put somewhere for next February.', 1],
    ]),
  ];
