(function () {
  ...
  const worlds = [
    world("The First Airport Hug", "where distance finally loses", "The doors slide open and every rehearsed sentence disappears. There is only you, me, the dropped bag, and the kind of hug that makes a whole year of waiting leave the body at once.", galleries.airport, [
    ...
    world("Santorini in Lilac Light", "white walls, lavender sky", "We wake where the sea holds every shade of blue, but sunset belongs to lilac. I take too many pictures of you, then put the phone away because no photograph can keep the way you look when the light turns soft.", galleries.europe, [
    ...
    world("Maldives, No Schedule", "a room floating on water", "Here the day has no sharp edges. The floor is warm, the water is clear, and time is measured by swims, fruit, naps, kisses, and whether your hair is still wet.", galleries.islands, [
    ...
    world("Paris After Midnight", "the city when it whispers", "Not rushed Paris. Ours begins after dinner, when the streets shine from rain and the city becomes quiet enough for our footsteps to sound like part of the music.", galleries.europe.slice().reverse(), [
    ...
    world("Kyoto Blossom Rain", "petals in your hair", "Spring keeps letting go of pink petals around us. We walk beneath old trees, speak more quietly without deciding to, and keep finding small beautiful things tucked beside the path.", galleries.garden, [
    ...
    world("Zanzibar Barefoot Morning", "salt, spice, and sunlight", "The morning starts with the sea and ends somewhere inside a market full of color. Everything is warm: the sand, the bread, the air, and your shoulder against mine.", galleries.islands.slice(1).concat(galleries.warm.slice(0, 1)), [
    ...
    world("The Swiss Window Seat", "mountains passing like cinema", "We take the slow train on purpose. Snow, lakes, villages, and green valleys move past the glass while your head rests on my shoulder and our snacks slowly disappear.", galleries.mountains, [
    ...
    world("New York Winter Lights", "cold hands, warm city", "The city moves fast, so we make our own slow pocket inside it. Your scarf is too cute, my hand is your heater, and every window is dressed like it knew you were coming.", galleries.city, [
    ...
    world("Bali Hidden Garden", "green doors and flower baths", "We disappear behind carved doors into a garden that feels invented. Water runs over stone, flowers float everywhere, and the morning smells like rain and frangipani.", galleries.warm.slice(2).concat(galleries.garden.slice(1)), [
    ...
    world("Cappadocia Before Sunrise", "balloons above the quiet", "We wake while the world is still dark, wrap ourselves in layers, and climb to the roof. Then color begins lifting into the sky, one balloon at a time.", [photo("photo-1528181304800-259b08848526"), ...galleries.mountains.slice(0, 2).map(photo)].map(url => url.replace(photo(""), "")), [
    ...
    world("Venice After Rain", "reflections under every bridge", "Rain empties the lanes and polishes the stone. The city becomes silver, lilac, and gold, with little boats cutting through reflections that look painted.", [photo("photo-1523906834658-6e24ef2386f9"), ...galleries.europe.slice(0, 2).map(photo)], [
    ...
    world("Nairobi, Our Date Day", "a whole day close to home", "Not every dream needs a passport. We make a full little holiday out of the city: flowers, food, music, a long drive, and the relief of finally being in the same place.", [photo("photo-1516026672322-bc52d61a55d5"), photo("photo-1493666438817-866a91353ca9"), photo("photo-1528605248644-14dd04022da1")], [
    ...
    world("Seychelles Secret Cove", "granite, lilies, clear water", "We find a small curve of beach between smooth rocks and claim it for the afternoon. The water is glassy, the shade is cool, and nobody needs anything from us.", galleries.islands.slice().reverse(), [
    ...
    world("London Bookshop Rain", "stories, tea, and your hand", "Rain gives us permission to spend the day indoors. We move from bookshop to cafe to museum, carrying one umbrella and a growing stack of things we chose for each other.", galleries.city.slice().reverse(), [
    ...
    world("Rome at Golden Hour", "warm stone and slow evenings", "Rome feels sunlit even after the sun leaves. We walk between fountains and old walls, stopping for photographs, cold drinks, and kisses in streets that have seen every kind of love.", [photo("photo-1529260830199-42c24126f198"), photo("photo-1552832230-c0197dd311b5"), photo("photo-1531572753322-ad063cecc140")], [
    ...
    world("Northern Lights Cabin", "the sky learning magic", "Outside is snow and impossible color. Inside is warm wood, thick socks, soup on the stove, and a window wide enough to let the entire sky join us.", galleries.mountains.slice().reverse(), [
    ...
    world("Marrakech Lantern Night", "rose walls and amber light", "The city is color layered over sound. We wander through courtyards, tiled rooms, spice stalls, and rooftop lanterns until the night feels like a story told just to us.", galleries.warm, [
    ...
    world("Amalfi Lemon Afternoon", "sunlight the color of joy", "The road curls above the sea and every balcony grows flowers. We spend the afternoon between lemon trees, striped umbrellas, cold drinks, and views that keep interrupting our conversation.", galleries.warm.slice(1).concat(galleries.europe.slice(0, 1)), [
    ...
    world("Our Tiny Kitchen", "the destination called ordinary", "This one matters as much as every passport stamp. It is our kitchen, our mugs, your things beside mine, and the quiet miracle of not needing a call to share the same room.", galleries.home, [
    ...
    world("The Sunday Bedroom Fort", "rain outside, us inside", "Blankets become walls, pillows become architecture, and Sunday becomes a country with only two citizens. Nothing impressive happens. That is why I want it so much.", galleries.home.slice().reverse(), [
    ...
    world("Twenty-Fifth of April", "our date, made into a place", "Imagine a world where the calendar always reads 25 April. Lilies bloom in every doorway, the sky stays tender, and every path leads back to the moment we chose to call ours.", [photo("photo-1490750967868-88aa4486c946"), photo("photo-1497250681960-ef046c08a56e"), photo("photo-1526047932273-341f2a7631f9")], [
      ...
      ["The next-year wish", "Before midnight we each name one ordinary thing we want to be doing together by the next 25 April."]
    ], "anniversary")
  ];
  ...
  const notices = [
    ...
    "How you overthink because you care about getting things right, even when your heart deserves rest.",
    ...
    "How beautiful you are when you are not arranging your face for a photograph.",
    ...
    "How you make me want to be careful with language because your heart is worth speaking to well.",
    "The way you can be playful one minute and deeply thoughtful the next.",
  ...
  const memories = [
    ...
    ["The day 2504 became a key", "A date became more than numbers. It became a way back into our story, a small code that says this belongs to us."],
